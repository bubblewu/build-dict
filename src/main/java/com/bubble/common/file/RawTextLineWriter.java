...
public class RawTextLineWriter extends AbstractDataWriter<byte[]> {
     ...
     *  </ul>
     */
    public static class Factory extends AbstractDataWriterFactory<byte[]> {
        ...
        @Override
        public AbstractDataWriter<byte[]> constructWriter(OutputStream out) {
            if (_addBuffering) {
