 ...
 */
public class RawTextLineReader extends AbstractDataReader<byte[]> {
    ...
    public int estimateSizeInBytes(byte[] item) {
        // 大胆猜测：数组对象至少占用8个字节，可能为12或16。
        // 和实际阵列存储器的大小四舍五入到4字节对齐。所以:
    ...
    public static class Factory
            extends AbstractDataReaderFactory<byte[]> {
        @Override
        public AbstractDataReader<byte[]> constructReader(InputStream in) {
